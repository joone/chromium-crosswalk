...
// attribute setter methods
    ...
    void setPolarAngle(float v) { SET_VAR(surround, polar.m_hasPolar, true); SET_VAR(surround, polar.m_angle, v); }
    void setPolarDistance(const Length& v) { SET_VAR(surround, polar.m_hasPolar, true); SET_VAR(surround, polar.m_distance, v); }
    ...
    bool hasPolar() const { return surround->polar.hasPolar(); }
    ...
    static Length initialPolarAnchorX() { return Length(50.0, Percent); }
    static Length initialPolarAnchorY() { return Length(50.0, Percent); }
    static Length initialPolarOriginX() { return Length(Auto); }
    static Length initialPolarOriginY() { return Length(Auto); }
    static float initialPolarAngle() { return 0.0; }
